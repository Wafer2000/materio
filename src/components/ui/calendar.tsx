      ...
      components={{
        ...
        Dropdown: (props) => {
          ...
          if (props.name === "months") {
            ...
            return (
              <Select>
                <SelectTrigger>Mes</SelectTrigger>
                <SelectContent>
            ...
            if (earliestYear && latestYear) {
              const yearsLenght = latestYear - earliestYear + 1;
              selectItems = Array.from({ length: yearsLenght }, (_, i) => ({
            ...
            return (
              <Select>
                <SelectTrigger>Año</SelectTrigger>
                <SelectContent>
                  {selectItems.map((selectItem) => (
                    <SelectItem value={selectItem.value}>
                      {selectItem.label}
